...
*/
    ...
    $url = $_url.$url;
    $url = "http://mp.weixin.qq.com/s?timestamp=1488164360&src=3&ver=1&signature=Ire-Gj443E6r8JE1siAxtCB0R*cYYphfDUStgS5BnoFuFeSdJBiEQ4xRfBTMoxQgGQVlMJIVCrKbFcV9w4rVWf2cpc51LIi*YdWHIZxdP1XHS6kRVbp4J*fyLZ-2Q4w2KSoYCPTFnKayXuUqyM-BVduC62Qe81OGWPK-9kdPirE=";
    $html = $curl->curlRequest($url)['response'];
    //$html = file_get_contents('html.html');
    phpQuery::newDocumentHTML($html, 'utf8');
