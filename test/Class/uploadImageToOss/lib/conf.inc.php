...
// 个人测试
// ACCESS_ID
// define('OSS_ACCESS_ID', '4ugYL5RFCXWWLyip');
define('OSS_ACCESS_ID', 'HouyaZTN2jKJALul');
// ACCESS_KEY
// define('OSS_ACCESS_KEY', 'eO10TWbWcGEkTJcasXSQLsYDNqXGVZ');
define('OSS_ACCESS_KEY', 'bTg4tYS2xY8d3mcHCvkGZZYlfWfLjs');
// 是否记录日志
