...
class Curl_request {  
     ...
     * @return void 
     */  
    public function __construct($url, $mark = '', $method = 'GET', $post_data = null, $headers = null, $options = null) {  
        $this->url = $url;  
        $this->mark = $mark;
...
class Curl {  
    ...
    private $options        = array (
                                ...
                                CURLOPT_USERAGENT => 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.93 Safari/537.36', 
     ...
     * @var array 
     */  
    private $headers        = array();//array ("__flash_buy_ad_cookie: ok", "Cookie: __flash_buy_ad_cookie=ok; PHPSESSID=fd3afd076d9cee24906c03a118c20d70; ipeen_anonymous=ec514f07cd8abdb93517b97c00925189; lbss=0; lbsa=taiwan");  
    /** 
     * 请求列队 
     * @var array 
     */  
